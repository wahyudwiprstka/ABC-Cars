...
<body>
	...
	<div class="content mb-2 regis container d-flex align-items-center justify-content-center">
		...
		<div>
				<form:form modelAttribute="update-profile" class="d-flex flex-column justify-content-center registration-form" action="${pageContext.request.contextPath}/admin/update-profile-process/${user.id}" method="post">
